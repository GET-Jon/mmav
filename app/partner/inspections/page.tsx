    ...
    <header className="border-b border-slate-200 bg-white">
      <div className="mx-auto flex w-full max-w-[1240px] items-center justify-between gap-4 px-4 py-4 sm:px-5 lg:px-7">
        ...
        <div className="flex items-center gap-4">
          <nav className="flex flex-wrap gap-1.5"><Link href="/partner/work" className="rounded-lg px-3 py-2 text-sm font-black text-slate-600">Today</Link><Link href="/partner/work?view=all" className="rounded-lg px-3 py-2 text-sm font-black text-slate-600">My Work</Link><Link href="/partner/work#schedule" className="rounded-lg px-3 py-2 text-sm font-black text-slate-600">Schedule</Link><Link href="/partner/inspections" className="rounded-lg bg-slate-950 px-3 py-2 text-sm font-black text-white">Inspections</Link><Link href="/partner/profile" className="rounded-lg px-3 py-2 text-sm font-black text-slate-600">Profile</Link></nav>
