    ...
    const preliminary = await generatePreliminaryWorkPlan({
      ...
      upgrades: overview.upgrades
        ...
        .map((upgrade) => ({
          ...
          notes: upgrade.notes,
          mechanicalValidationStatus: upgrade.mechanicalValidationStatus,
          mechanicalValidationNotes: upgrade.mechanicalValidationNotes,
          mechanicalRecommendedAction: upgrade.mechanicalRecommendedAction,
          mechanicalCanPerform: upgrade.mechanicalCanPerform,
          mechanicalLaborHours: upgrade.mechanicalLaborHours,
          mechanicalProposedLaborPrice: upgrade.mechanicalProposedLaborPrice,
          mechanicalSuggestedParts: upgrade.mechanicalPartSuggestions,
        })),
    });
