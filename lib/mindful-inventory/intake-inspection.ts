...
export type InventoryFindingView = {
  ...
  mechanicalCanPerform: boolean | null; mechanicalLaborHours: number | null;
  mechanicalOwnerReviewStatus: "accepted" | "dismissed" | null; mechanicalOwnerReviewNotes: string | null;
