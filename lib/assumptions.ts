  ...
  vehicleClassificationRules: [
    {
      name: "EV / Hybrid",
      matchType: "fuel",
      matchValues: ["electric", "hybrid", "ev", "phev"],
      costProfile: "EV / Hybrid",
      priority: 50,
      enabled: true,
    },
    {
      ...
      costProfile: "Performance / Enthusiast",
      priority: 40,
      enabled: true,
    },
    {
    ...
    },
    {
      ...
      costProfile: "Luxury / German",
      priority: 20,
      enabled: true,
    },
    {
      name: "Older / High-Mile",
      matchType: "ageMileage",
      matchValues: ["10 years", "120000 miles"],
      costProfile: "Older / High-Mile",
      priority: 60,
      enabled: true,
    },
  ],
