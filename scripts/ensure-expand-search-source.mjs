...
const overviewChanged = updateFile(overviewPath, (source) => {
  ...
  if (updated.includes(firstGuidedTitleCard)) {
    updated = updated.replace(firstGuidedTitleCard, guidedTitleCard);
  } else if (!updated.includes(guidedTitleCard) && updated.includes(oldTitleCard)) {
